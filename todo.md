...
- add some different AI stratgies: 
- - bezerk focus on port 
- - only attack settlements
- - attack in groups vs flank
- - rertreat when at 25% health. 
...
- whirlpoool that sucks in ships
- winds that speed up play
- attack bonuses 
- "stim packs" for ships (runes/ability tiles you charge and activiate)
